...
\lecture{Statistical Techniques in Robotics (16-899, S11)}
{Lecture \#09, (Feb. 8, 2011)}
{Lecturer: Stephane Ross}{Scribe: Jackie Libby}{Temporal Difference Methods}

% Be sure to acknowledge all previous scribes.
%\footnotetext[1]{Some content adapted from previous scribs: Hyunggi Cho and Alberto Rodriguez}
